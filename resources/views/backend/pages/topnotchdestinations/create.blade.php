...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="my-1 float-left"><i class="fas fa-info-circle text-blue"></i>&nbsp;{{ 'Add New - Premier Pick' }}</h3>
        ...
        <div class="card-body">
            <form action="{{ route('top-notch-destinations.store') }}" method="post" class="form" enctype="multipart/form-data">
                @csrf

...
@section('content')
 ...
 <section class="inner-banner-wrap">
   <div class="inner-baner-container" id="inner-package-banner">
      <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-lg-4">
            <div class="sidebar">
               ...
               <div class="widget-bg information-content text-left">
                  <h5>TRAVEL TIPS</h5>
               ...
               <div class="gta-package-content text-left">
                  <h5>MORE PACKAGES</h5>
                  <h3>OTHER TRAVEL PACKAGES</h3>
                  <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus.</p>
                  <ul>
                     <li>
